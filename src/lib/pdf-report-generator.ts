...
export function generateCompleteTaxReport(data: TaxReportData): void {
    ...
    for (let i = 1; i <= pageCount; i++) {
        ...
        doc.setTextColor(...grayColor);
        doc.text(
            `Page ${i} of ${pageCount} | Generated by TaxMitra | This is a system-generated report`,
            pageWidth / 2,
    ...
    doc.text('Tax calculations are based on available data and may require verification. TaxMitra is not liable for any discrepancies.', 14, disclaimerY + 16);
